package com.eucl.tokenmgmt.config;

import com.eucl.tokenmgmt.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(
                "http://localhost:3000", // For local front-end development (e.g., React)
                "http://localhost:8090",
                "https://your-production-frontend.com" // Add your production front-end URL
        ));
